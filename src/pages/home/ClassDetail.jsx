    ...
    const registerCourseUser = async () => {
        ...
        if (!dataUser) {
          ...
          const paymentFetch = async () => {
            const data =  await fetch(`https://14.225.204.233:8000/payment/process`,{
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({
                    orderId: '123abc', // Truyền orderId
                    amount: "2000000",
                    title: 'Payment', // Thêm tham số title
                    ipUser: '127.0.0.1',
                    locales: 'vn',
                    emailClient: "quyennguyen_5@jobspeeds.com",
                    phoneClient: "0909898990",
                    idClient: "123456"
                })})
