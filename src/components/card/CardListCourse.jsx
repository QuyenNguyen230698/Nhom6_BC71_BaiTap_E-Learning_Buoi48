...
export default function CardListCourse({dataImg}) {
  ...
  return (
    <div className='w-full lg:max-w-6xl h-full flex flex-col gap-4 justify-center items-center pb-10 container mx-auto px-3'>
        <div data-aos="fade-up" data-aos-delay="100" className='uppercase text-2xl lg:text-5xl text-black-gray font-light text-center w-full py-8'>Danh sách khóa học</div>
        {/* nav search */}
