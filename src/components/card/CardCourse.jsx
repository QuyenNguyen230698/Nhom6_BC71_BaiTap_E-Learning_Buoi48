...
export default function CardCourse() {
  ...
  return (
    <div className='w-full h-full flex flex-col justify-center items-center bg-home py-10 px-3'>
      ...
      <div className='w-full lg:max-w-6xl h-auto lg:h-full items-stretch justify-stretch container mx-auto grid grid-cols-6 gap-5'>
        {listCourseCatalog?.map((course, idx) => (
          <div key={idx} data-aos="fade-up" data-aos-delay="100" className='w-full h-96 lg:h-full leading-none flex flex-col justify-stretch col-span-6 md:col-span-3 lg:col-span-2 shadow-lg rounded-lg overflow-hidden'>
            ...
            <div className='w-full h-fit flex flex-col justify-center text-black-gray p-3 lg:gap-3'>
                <h3 className='text-2xl lg:text-3xl font-light text-black-gray leading-none pb-2'>{course.tenDanhMuc}</h3>
                <p className='text-sm lg:text-base text-justify text-black-gray leading-none py-1'>Lập trình hiện đang là xu hướng trên toàn thế giới...</p>
                <div className='flex flex-wrap w-full justify-start items-start gap-3 border-b border-gray-300 py-2 leading-none'>
                ...
                <div className='flex flex-row w-full h-auto items-center justify-between py-2 md:gap-2 leading-none'>
